import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.419948d5.js";const _=JSON.parse('{"title":"CircleScan","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Effects/CircleScan.md","filePath":"guide/Effects/CircleScan.md"}'),p={name:"guide/Effects/CircleScan.md"},o=l(`<h1 id="circlescan" tabindex="-1">CircleScan <a class="header-anchor" href="#circlescan" aria-label="Permalink to &quot;CircleScan&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 圆形雷达扫描</span></span>
