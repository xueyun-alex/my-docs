import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.be97d476.js";const C=JSON.parse('{"title":"CircleDiffusion","description":"","frontmatter":{},"headers":[],"relativePath":"guide/Effects/CircleDiffusion.md","filePath":"guide/Effects/CircleDiffusion.md"}'),p={name:"guide/Effects/CircleDiffusion.md"},o=l(`<h1 id="circlediffusion" tabindex="-1">CircleDiffusion <a class="header-anchor" href="#circlediffusion" aria-label="Permalink to &quot;CircleDiffusion&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 圆扩散</span></span>
